 ...
 * @author Shai Almog
 */
public class FoodAppStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "FoodApp";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new FoodAppStub());
    }
